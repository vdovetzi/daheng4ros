...
VxInt32 DHDECL DxRaw8toRGB24(
  ...
  VxUint32 nHeight, DX_BAYER_CONVERT_TYPE cvtype, DX_PIXEL_COLOR_FILTER nBayerType, bool bFlip);
...
VxInt32 DHDECL DxRaw16toRGB48(
  void *pInputBuffer, void *pOutputBuffer, VxUint32 nWidth,
  VxUint32 nHeight, DX_ACTUAL_BITS nActualBits, DX_BAYER_CONVERT_TYPE cvtype,
...
VxInt32 DHDECL DxRaw8toARGB32(
  void *pInputBuffer, void *pOutputBuffer, VxUint32 nWidth,
  VxUint32 nHeight, int nStride, DX_BAYER_CONVERT_TYPE cvtype, DX_PIXEL_COLOR_FILTER nBayerType,
...
VxInt32 DHDECL DxRaw8ImgProcess(
  void *pRaw8Buf, void *pRgb24Buf, VxUint32 nWidth, VxUint32 nHeight,
...
VxInt32 DHDECL DxGetFFCCoefficients(
  ...
  void *pFFCCoefficients, int *pnlength, int *pnTargetValue = NULL);
...
*/
//--------------------------------------------------
VxInt32 DHDECL DxFlatFieldCorrection(
  void *pInputBuffer, void *pOutputBuffer,
  DX_ACTUAL_BITS nActualBits, VxUint32 nImgWidth, VxUint32  nImgHeight, void *pFFCCoefficients,
  int *pnLength);
...
VxInt32 DHDECL DxCalcUserSetCCParam(
  COLOR_TRANSFORM_FACTOR *pstColorTransformFactor,
  VxInt16 nSaturation, VxInt16 *parrCC, VxUint8 nLength);
...
*/
//--------------------------------------------------
VxInt32 DHDECL DxImageFormatConvert(
  DX_IMAGE_FORMAT_CONVERT_HANDLE handle, void *pInputBuffer,
  int nInBufferSize, void *pOutputBuffer, int nOutBufferSize, GX_PIXEL_FORMAT_ENTRY emInPixelFormat,
  VxUint32 nImgWidth, VxUint32  nImgHeight, bool bFlip);
...
VxInt32 DHDECL DxImageFormatConvertGetBufferSizeForConversion(
  DX_IMAGE_FORMAT_CONVERT_HANDLE handle,
  GX_PIXEL_FORMAT_ENTRY emPixelFormat, VxUint32 nImgWidth, VxUint32  nImgHeight, int *pBufferSize);
...
*/
//-------------------------------------------------------------
VxInt32 DHDECL DxStaticDefectCorrection(
  void *pInputBuffer, void *pOutputBuffer,
  STATIC_DEFECT_CORRECTION stDefectCorrection, void * pDefectPosBuffer,
  VxUint32 nDefectPosBufferSize);
...
*/
//--------------------------------------------------
VxInt32 DHDECL DxCalcCameraLutBuffer(
  VxInt32 nContrastParam, double dGamma, VxInt32 nLightness,
  void *pLut, VxUint32 *pnLutLength);
...
*/
//------------------------------------------------
VxInt32 DHDECL DxRotate90CW16B(
  void * pInputBuffer, void * pOutputBuffer, VxUint32 nWidth,
  VxUint32 nHeight);
...
*/
//------------------------------------------------
VxInt32 DHDECL DxRotate90CCW16B(
  void * pInputBuffer, void * pOutputBuffer, VxUint32 nWidth,
  VxUint32 nHeight);
...
*/
//-------------------------------------------------------------
VxInt32 DHDECL DxImageMirror16B(
  void *pInputBuffer, void *pOutputBuffer, VxUint32 nWidth,
  VxUint32 nHeight, DX_IMAGE_MIRROR_MODE emMirrorMode);
